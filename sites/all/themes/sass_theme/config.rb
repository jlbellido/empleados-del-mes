...
#
# Este archivo sólo es necesario para la integración de Compass / Sass. Si no va a utilizar 
# Compass, puede ignorar o borrar este archivo de manera segura. 
# 
# Si desea obtener más información sobre Sass y Compass, consulte la insolencia / _readme.txt 
# Archivo para más información. 
...
output_style = (environment == :nested) ? :expanded : :compact
...
sass_options = (environment == :expanded) ? {:debug_info => false} : {:always_update => true}
